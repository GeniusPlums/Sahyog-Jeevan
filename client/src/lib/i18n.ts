  ...
  en: {
    translation: {
      common: {
        ...
        jobListingDesc: "Find your next opportunity",
        filters: "Filters",
        jobType: "Job Type",
        shift: "Shift",
        ...
        noJobsMatchFilter: "No jobs match your filter criteria",
  ...
  hi: {
    translation: {
      common: {
        ...
        jobListingDesc: "अपना अगला अवसर खोजें",
        filters: "फ़िल्टर",
        ...
        noJobsMatchFilter: "कोई नौकरी आपके फ़िल्टर मानदंडों से मेल नहीं खाती",
